    ...
    public partial class FlowToVisioControl : PluginControlBase
    {
            ...
            string relationship, string name)
        {
            ...
            if (!filePackage.PartExists(packageLocation))
            {
                ...
                var newPackagePart = filePackage.CreatePart(packageLocation,
                    contentType);
                // Create a stream from the package part and save the XML document to the package part.
                using (var partStream = newPackagePart.GetStream(FileMode.Create,
            ...
            var ns = pagesXml.Root.GetNamespaceOfPrefix("r");
        ...
        private void RemoveTemplate()
        {
            ...
            var newPages = package.CreatePart(pagesURI, contentType);
            foreach (var relationship in relationships)
            {
                newPages.CreateRelationship(relationship.TargetUri, TargetMode.Internal, relationship.RelationshipType,
                    relationship.Id);
            }
        ...
        private static int CheckForRecalc(XDocument customPropsXDoc)
        {
            ...
            var recalcProp = GetXElementByAttribute(props,
                "name", "RecalcDocument");
        ...
        private static XDocument GetXMLFromPart(PackagePart packagePart)
        {
            ...
            var partXml = XDocument.Load(partStream, LoadOptions.PreserveWhitespace);
            return partXml;
        }
